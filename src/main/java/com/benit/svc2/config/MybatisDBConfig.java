...
public class MybatisDBConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource datasource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:queries/**/*.xml"));     // 쿼리문 위치 설정
    ...
    public HikariDataSource dataSource(){
        ...
        config.setPassword("Harin160502!@");
